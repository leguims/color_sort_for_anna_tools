...
set repertoire_source=..\..\Pipelines_rapide\pipeline_6_plateaux_avec_difficulte\*
...
for /d %%D in (%repertoire_source%) do (
    ...
    if "%%~nxD" == ".git" (
        ...
        set nom_cible_compressee=pipeline_6_Plateaux_Difficulte-Archive_compressee-%%~nxD.7z
