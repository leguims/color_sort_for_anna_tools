...
set repertoire_source=..\..\Pipelines_rapide\pipeline_4_filtre_doublons_permutation_piles\*
...
for /d %%D in (%repertoire_source%) do (
    ...
    if "%%~nxD" == ".git" (
        ...
        set nom_cible_compressee=pipeline_4_Filtre-Archive_compressee-%%~nxD.7z
